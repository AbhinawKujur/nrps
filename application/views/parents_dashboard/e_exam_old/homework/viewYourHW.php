...
<div class='row'>
	...
	<div class='col-sm-10 col-md-10'>
		...
		<br/>  
		<?php $Ans_image = (!empty($val['img']))?$val['img']:''?>
	<br/><span style="float:right;"><?php if($Ans_image){?><a href="<?=base_url().$Ans_image;?>" target="Blank"><img src="<?=base_url().$Ans_image;?>" style="width:250px;height:250px;float:right;"></a><?php } ?></span>	
