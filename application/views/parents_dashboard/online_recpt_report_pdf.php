...
<body>
    <div id="body">
        <div id="box1">
            <img src="<?php echo $school_logo; ?>" height="100px" width="100px;">
            <div class="table_heading">
                ...
                <center><span class="webemail">Website: <?php echo $school_web; ?></span></center><!-- <span class="webemail"> Email: <?php //echo $school_email; 
                                                                                                                                        ?></span> -->
                    ...
                    <td colspan="3">
                        <table width="100%" class="table1">
                            ...
                            <!--<tr class="tr1">
                                ...
                                <td class="td1" colspan="3"><?php //echo $bsn; 
                                                            ?></td>
                            </tr>-->
                            <tr class="tr1">
