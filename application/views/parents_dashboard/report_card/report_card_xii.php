	...
	<!-- end header -->
		<table border='1' cellspacing='0' class='tb'>
			...
			<tr>
				...
				<td><?php echo round($stuData[0]['sub1_th_obt']); ?></td>
			...
			<?php } ?>
				...
				<td><?php echo round($stuData[0]['sub2_th_obt']); ?></td>
			...
			<?php } ?>
				...
				<td><?php echo round($stuData[0]['sub3_th_obt']); ?></td>
			...
			<tr>
				...
				<td><?php echo round($stuData[0]['sub4_th_obt']); ?></td>
			...
			<?php } ?>
				...
				<td><?php echo round($stuData[0]['sub5_th_obt']); ?></td>
			...
			<tr>
				...
				<td><?php echo round($stuData[0]['sub6_th_obt']); ?></td>
			...
			<tr>
				...
				<td><?php echo round($stuData[0]['sub7_th_obt']); ?></td>
			...
			<tr>
				...
				<td><?php echo round($stuData[0]['sub8_th_obt']); ?></td>
