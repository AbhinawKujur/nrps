...
<body>
	<div id="body">
		<div id="box1">
			<img src="<?php echo base_url($school_logo); ?>" height="100px" width="100px" style='display:block;'>
			<table width="100%" id ='headingtab'>
				<tr>
					<td style ='font-weight:700;font-size:18px;text-align:center;'><?php echo $school_name; ?></td>
				</tr>
				<tr>
					<td style ='text-align:center;'><?php echo $school_add; ?></td>
				</tr>
				<tr>
					<td style ='text-align:center;'>Tel No: <?php echo $school_phone .' , Affln No:  '. $school_aff;; ?></td>
				</tr>
				<tr>
					<td style ='text-align:center;'>Website: <?php echo $school_web; ?></td>
				</tr>
				<tr>
					<td style ='text-align:center;'>FEE-RECEIPT(PARENT COPY)</td>
				</tr>
			</table>
			
			<!--<div class="table_heading">
				<center><span style ='font-weight:700;font-size:16px;' ><?php echo $school_name; ?></span></center><br />
				<center><span ><?php echo $school_add; ?></span></center><br />
				<center><span >Tel No: <?php echo $school_phone .' , Affln No:  '. $school_aff; ?></span></center><br />
				<center><span >Website: <?php echo $school_web; ?></span></center><br /><br /><!-- <span class="webemail"> Email: <?php //echo $school_email; ?></span> 
		...
		<form method="GET" action="<?php echo base_url('Parent_details/downlad_pdf') ?>">
			<input type="hidden" name="rectno" id="rectno" value="<?php echo $RECT_NO; ?>">
			<input type="hidden" name="admno" id="admno" value="<?php echo $ADM_NO; ?>">
			<center><button class="btn btn-success">Download PDF</button>
			<a href="<?php echo base_url('Onparent_details/pay_details') ?>" type="button" class="btn btn-primary">Back</a>
			</center>
