...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Student Information</a> <i class="fa fa-angle-right"></i></li>
</ol>
	...
	<form id="form" method="post">
		<div class="row">
			...
			<!--<div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 form-group">
				...
				<select class="form-control" required name="short_by">
					<option value="">Select Option</option>
					<option selected value="ADM_NO">Admission No</option>
					<option value="FIRST_NM">Name</option>
					<option value="ROLL_NO">Roll No</option>
				</select>
			</div>-->
			<table class='table' border='1'>
				<tr>
					<th style='color:#000; font-size:20px;' colspan='<?php echo count($class)?>'><center>CLASS/SEC</center></th>
				</tr>
				<tr>
				<?php
					foreach($class as $class_data){
						?>
							<td style='color:#000'><input type='checkbox' value="<?php echo $class_data->Class_No; ?>" name="class_name[]"><br /><?php echo $class_data->CLASS_NM; ?></td>
						<?php
					}
				?>
				</tr>
				...
				<?php
					foreach($sec as $sec_data){
						?>
							<td style='color:#000'><input type='checkbox' value="<?php echo $sec_data->section_no; ?>" name="sec_name[]"><br /><?php echo $sec_data->SECTION_NAME; ?></td>
						<?php
					}
				?>
				</tr>
