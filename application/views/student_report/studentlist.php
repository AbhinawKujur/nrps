...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Student List With Subject Taken</a> <i class="fa fa-angle-right"></i></li>
</ol>
...
<script>
    ...
    $("#form").on("submit", function(event) {
        ...
        $.ajax({
            url: "<?php echo base_url('Student_report/find_detailsstudentlist'); ?>",
            type: "POST",
            data: $('#form').serialize(),
            beforeSend: function() {
                $('.loader').show();
