...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Admission Form Sales Report</a> <i class="fa fa-angle-right"></i></li>
</ol>
...
<script>
    ...
    $("#form").on("submit", function(event) {
        ...
        $.ajax({
            url: "<?php echo base_url('Adm_form_sale/adm_form_details'); ?>",
            type: "POST",
            data: $('#form').serialize(),
            beforeSend: function() {
                $('.loader').show();
