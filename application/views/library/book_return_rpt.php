...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Book Return Report</a> <i class="fa fa-angle-right"></i></li>
</ol>
			  	...
			  	<div class='table-responsive'>
			  		...
			  		if(isset($return_rpt)){?>
						<table class='table' id='example' style="font-size: 13px;">		<thead>  		
					  			<tr>
					  				<th style="background:#337ab7;color:#fff !important;border:1px solid;">Emp. Id.</th>
