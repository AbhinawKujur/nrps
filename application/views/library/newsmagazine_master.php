		...
		<div class='col-sm-4'>
			...
			<div id='load'>
				<form action="<?php echo base_url('library/NewsMagazineMaster/save'); ?>" method='post' autocomplete='off'>
					...
					<!-- Days Fields (Initially hidden for Magazine) -->
					<div id="daysFields">
						<div class='row'>
							<div class='col-sm-6'>
								<div class="form-group">
					...
					<!-- Months and Part Fields (Initially hidden) -->
					<div id="monthPartFields" style="display: none;">
						<div class="form-group">
							<label>Month:</label>
...
<script>
	document.getElementById('typeSelect').addEventListener('change', function() {
		...
		if (type === 'Magazine') {
			// Hide days fields and show month/part fields
	...
	function newsMagazineMasterEdit(ItemID) {
		$.post("<?php echo base_url('library/NewsMagazineMaster/edit'); ?>", {
			ItemID: ItemID
		}, function(data) {
			$("#load").html(data);
		});
