				  ...
				  <div class="col-sm-3">
					  <div class="form-group">
						...
						<select class='form-control' id='rpttyp' name='rpttyp' >
							...
							<option value="0"<?php if ($reportType==0) { echo ' selected="selected"'; } ?>>Issued</option>					
							<option value="1"<?php if ($reportType==1) { echo ' selected="selected"'; } ?>>All Issued</option>
							<option value="2"<?php if ($reportType==2) { echo ' selected="selected"'; } ?>>Defaulter</option>							
						</select>
					  </div>
				  </div>
				  <div class="col-sm-3">
			  		...
			  		if(isset($isuu_rpt)){
						...
						<thead> 		
				  			<tr>
								...
								<th style="background:#337ab7;color:#fff !important;border:1px solid;">Student Name</th>
								<th style="background:#337ab7;color:#fff !important;border:1px solid;">Class-Sec</th>
				  		...
				  		<tbody>
							...
							?>
									...
									<td class="tab1"><?=$val['snm']?></td>
									<td class="tab1"><?=$val['cls']."-".$val['sec']?></td>
