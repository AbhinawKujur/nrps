<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Book Issued Status Report</a> <i class="fa fa-angle-right"></i></li>
</ol>
<style>
    .table>thead>tr>th,
    .table>tbody>tr>th,
        ...
        <div class='row'>
            ...
            <div class="col-md-3">
                <select name="sort_by" id="sort_by">
                    ...
                    <option value="2">ADM_NO</option>
                    <option value="3">Roll_no</option>
                </select>
            </div>      
            </fieldset> -->
...
<script>
        ...
        if ($('#cw').is(":checked") || $('#ac').is(":checked")) {
            if ($('#cw').is(":checked")) {
                ...
                if (viewupto != '') {
                    ...
                    if (classs != '') {
                        ...
                        if (sec != '') {
                            ...
                            $.ajax({
                                url: "<?php echo base_url('library/LibraryReport/book_issued_classwise') ?>",
                                type: "POST",
                                data: {
                                    viewupto: viewupto,
                                    classs: classs,
                ...
                if (viewupto != '') {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('library/LibraryReport/book_sts_allclasswise') ?>",
                        type: "POST",
                        data: {
                            viewupto: viewupto,
                            classs: classs,
    ...
    // function loadPartialDuesData(val) {
    //     // alert(val); 1
    //     $("#vis_det").html('');
    //     if (val == 1) {
    //         var viewupto = $("#viewupto").val(); //month name APR(4) , MAR(5)

    //         var classs = $("#classs").val(); // 9(VI)

    //         var sec = $("#sec").val(); //2 (B)

    //         var cw = $("#cw").val(); //1

    //         var text = 'partial'; //partial
