    ...
    <div style="padding: 10px; background-color: white;  border-top:3px solid #5785c3;">
    	<form onsubmit="return validation()" action="<?php echo base_url('Fees_collection/collection_without_adm_save'); ?>" method="POST">
	    	 <div class="row">
				...
				<input type="text" name="formno" autocomplete="off" id="formno" placeholder="Enter Form No" class="form-control" required onkeydown="return disableEnterKey(event)";>
			</div>
	    	...
	    	<div class="row">
	    		<div class="col-md-4 form-group">
	    			...
	    			<input type="text" name="stdname" placeholder="Name" id="stdname" class="form-control" required>
	    		</div>
	    		<div class="col-md-4 form-group">
				...
				<input type="text" placeholder="Collection Type" name="collection_type" id="collection_type" class="form-control" required onkeydown="return disableEnterKey(event)">
			</div>
        ...
        <div class="modal-body">
         ...
         <div class="row" style="display: none;" id="card_show">
         		<div class="col-md-12 form-group">
         			...
         			<input type="text" minlength="1" maxlength="16"  onkeydown="disableEnterKey2(event)" onkeypress='return IsAlphaNumeric(event)' ondrop="return false"  placeholder="Enter Card Number" autocomplete="off" name="card_name" id="card_name" class="form-control">
         		</div>
         	</div>
         	<div class="row" style="display: none;" id="cheque_show">
         		<div class="col-md-12 form-group">
         			<label>Cheque Number: <span id="cheque" class="span"></span></label>
         			<input type="text" minlength="1" maxlength="6" placeholder="Enter Cheque" onkeydown="disableEnterKey2(event)" onkeypress='return IsAlphaNumeric(event)' ondrop="return false"  autocomplete="off" name="chque_name" id="chque_name" class="form-control">
         		</div>
         	</div>
