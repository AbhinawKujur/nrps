        ...
        <div class="modal-body">
         ...
         <div class="row" style="display: none;" id="card_show">
         		<div class="col-md-12 form-group">
         			...
         			<input type="text" minlength="4" maxlength="16" onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Enter Card Number" autocomplete="off" name="card_name" id="card_name" class="form-control" value="0000">
         		</div>
         	</div>
         ...
         <div class="row" style="display: none;" id="bank_show">
         		<div class="col-md-12 form-group">
         			...
         			<select id="bank_name" name="bank_name" class="form-control">
						...
						<option value="<?php echo $bank_data->Bank_Name; ?>" <?php if($bank_data->Bank_Name=='Axis Bank') {echo "selected";} ?> ><?php echo $bank_data->Bank_Name; ?></option>
         							<?php
         						}
         					}
         				?>
