			...
			<div class="row">
				<?php
	    		  if($feehead1!="" && $feehead1!="-")
	    		  {
	    			  ...
	    			  <input type="text" name="feehead1" onkeypress="return event.charCode>=48 && event.charCode<=57 || event.charCode==46" value="0" id="feehead1" onchange="amtref()" class="form-control" readonly>
	    		      </div>
	    		 <?php
	    		  }
	    		  else
