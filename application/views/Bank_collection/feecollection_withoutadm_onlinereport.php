...
<body onload="printl_url()">
                ...
                <tr>
                    <td colspan="3">
                        <table width="100%" class="table1">
                            <tr class="tr1">
                                <td class="td1" colspan="2">Receipt No:</td>
                                <td class="td1"><?php echo $RECT_NO; ?></td>
                                <td class="td1" colspan="2">Receipt Date:</td>
                                <td class="td1" colspan="2"><?php echo $date_format; ?></td>
                            </tr>
                            <tr class="tr1">
                                <td class="td1" colspan="2">Student Name:</td>
                                <td class="td1" colspan="3"><?php echo $STU_NAME; ?></td>
                            </tr>
                            <tr class="tr1">
                                <td class="td1">Class/Sec:</td>
                                <td class="td1"><?php echo $CLASS; ?></td>
                                <td class="td1" colspan="2">Payment Mode:</td>
    ...
    <div style="position: relative; margin-top: 50%; margin-left: 45%;">
        <button class="btn btn-primary" id="printing_button" onclick="printl()">PRINT</button>&nbsp;<a class="btn btn-danger" id="print_cancel" href="<?php echo base_url('Bank_collection/collection_without_adm/') ?>">BACK</a>
    </div>
    <br>
    <br>
    <br>
