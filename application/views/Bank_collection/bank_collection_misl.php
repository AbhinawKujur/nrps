...
?>
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Bank Miscellaneous Collection</a> <i class="fa fa-angle-right"></i></li>
</ol>

<div style="padding: 10px; background-color: white;  border-top:3px solid #5785c3;">
    <form onsubmit="return validation()" action="<?php echo base_url('Bank_collection/bank_misc_collection_data'); ?>" method="post">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-4 form-group">
                        ...
                        <input type="date" class="form-control" name="rcpt_date" id="rcpt_date" value="<?php echo date('Y-m-d'); ?>" id="recpitedate" onchange="pay_date(this.value)" onkeydown="disableEnterKey(event)">
                    </div>
                    <div class="col-md-4 col-xs-4 form-group">
                        <label>Admission No.</label>
                        <input list="browsers" onchange="adm_function(this.value)" name="adm_no" class="form-control" id='adm_no'>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" style="display: none;" id="card_show">
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" minlength="1" maxlength="50" onkeydown="disableEnterKey2(event)" onkeypress='return IsAlphaNumeric(event)' ondrop="return false" placeholder="Enter Card Number" autocomplete="off" name="card_name" id="card_name" class="form-control">
                            </div>
                        </div>
                        <div class="row" style="display: none;" id="cheque_show">
                            <div class="col-md-12 form-group">
                                <label>Cheque Number: <span id="cheque" class="span"></span></label>
                                <input type="text" minlength="1" maxlength="8" placeholder="Enter Cheque" onkeydown="disableEnterKey2(event)" onkeypress='return IsAlphaNumeric(event)' ondrop="return false" autocomplete="off" name="chque_name" id="chque_name" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row" id="pay_date" style="display: none;">
                            <div class="form-group col-md-12">
                                ...
                                <input type="date" name="pd" id="pd" readonly value="<?php echo date('Y-m-d'); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row" id="button" style="display: none;">
                            <div class="form-group col-md-12">
                                <center><input type="submit" name="submit" id="submit" value="CONFIRM PAYMENT" class="btn btn-success"></center>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function adm_function(val) {
        $.ajax({
            url: "<?php echo base_url('Bank_collection/miss_dataajax'); ?>",
            type: "POST",
            data: {
                val: val
            },
    ...
    function show_ledger() {
        ...
        var adm = $("#adm_no").val();
        $.ajax({
            url: "<?php echo base_url('Bank_collection/showledger_misc'); ?>",
            type: "POST",
            data: {
                adm: adm
            },
