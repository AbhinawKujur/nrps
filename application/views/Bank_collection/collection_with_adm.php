...
<div style="padding: 10px; background-color: white;  border-top:3px solid #5785c3;">
    <form onsubmit="return validation()" action="<?php echo base_url('Bank_collection/collection_without_adm_save'); ?>" method="POST">
        <div class="row">
            <div class="col-md-6 form-group">
                <label>Receipt Date<span id="rd" class="span"></span></label>
                <input type="date" name="recpitdate" value="<?php echo date('Y-m-d'); ?>" id="recpitedate" class="form-control" onchange="pay_date(this.value)" onkeydown="disableEnterKey(event)">
            </div>
            <div class="col-md-6 form-group">
        ...
        <div class="row">
            <div class="col-md-4 form-group">
                ...
                <input type="text" name="stdname" placeholder="Name" id="stdname" class="form-control">
            </div>
            <div class="col-md-4 form-group">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" style="display: none;" id="card_show">
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" minlength="1" maxlength="50" onkeydown="disableEnterKey2(event)" 

                                onkeypress='return IsAlphaNumeric(event)' ondrop="return false" 
                                
                                placeholder="Enter Card Number" autocomplete="off" name="card_name" id="card_name" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row" style="display: none;" id="cheque_show">
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" minlength="1" maxlength="6" placeholder="Enter Cheque" onkeydown="disableEnterKey2(event)" autocomplete="off" name="chque_name" id="chque_name" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row" id="pay_date" style="display: none;">
                            <div class="form-group col-md-12">
                                ...
                                <input type="date" name="pd" id="pd" disabled value="<?php echo date('Y-m-d'); ?>" class="form-control">
                            </div>
                        </div>
