...
<body onload="printl_body()">
	...
	<div style="position: relative; margin-top: 50%; margin-left: 45%;">
		<button class="btn btn-primary" id="printing_button" onclick="printl()">PRINT</button>&nbsp;<a class="btn btn-danger" id="print_cancel" href="<?php echo base_url('Bank_collection/bank_collection_misl/') ?>">BACK</a>
	</div>
	<br>
	<br>
	<br>
