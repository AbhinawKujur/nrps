...
<body>
	...
	?>
			...
			<div style="border:5px solid #000; padding:10px;" id='dyn_<?php echo $j; ?>'>
				...
				<table style='font-size: 10px !important;padding: 1px !important;width:100%; margin-top:-15px !important;'>
					<tr>
						<th>Admission No. :</th>
				...
				<table class='table'>
					...
					<?php foreach ($data['sub'] as $subject) { ?>
						<tr>
							...
							<td class='th'>
								<center><?php echo $subject['marks']['sum_term1_term2']; ?></center>
							</td>
							<td class='th'>
						...
						if ($subject['opt_code'] != 1) {
							$grnd_tot += $subject['marks']['sum_term1_term2'];
							$i += 1;
						}
						$grd = $grnd_tot / $i;
				...
				<div class='row'>
					<div class='col-xs-8'>
						<table class='table' border='1' style="width:100%">
							...
							<tr>
								<td class='th' colspan='2' style='height:20px;'><b>Remarks:&nbsp;&nbsp;&nbsp;<?php echo ucfirst($data['rmks']); ?></b></td>
							</tr>
						</table>
					</div>
				...
				<div class='row'>
					<div class='col-sm-12'>
						<table style='font-size:10px;width:100%;'>
							...
							<tr>
								<td><br />Date of Result declaration:  <?php echo '21-MARCH-2025'; ?>  </td>
							</tr>
						</table>
					</div>
				</div>
