				...
				<table class='table1'>
					...
					<tr>
						...
						<td style="padding: 8px !important;"><?php
																if ($data['DISP_SEC'] == 'F') {
																	echo ": " . $data['tot_present_day'] . '/' . '206';
																} elseif( $data['DISP_CLASS'] == 'VII' ){
																	echo ": " . $data['tot_present_day'] . '/' . '206';
																}else {
																	echo ": " . $data['tot_present_day'] . '/' .  '206';
																} ?>
				...
				<div class='row'>
					<div class='col-xs-12'>
						<table class='table' border='1' style="width:100%;font-size: 12px">
							...
							<tr>
								<td colspan='2' style='height:80px;' 'border:1px;'><b>Remarks:</b><br /><?php echo $data['rmks']; ?></td><br /><br />
							</tr>
						</table>
					</div>
				...
				<div class='row'>
					<div class='col-sm-12'>
						<table class='table' style="font-size: 12px;">
							...
							<tr>
								<td><br /><b>Date of Result declaration: 05-OCT-2024 </b></td><br />
							</tr>
						</table>
					</div>
				</div>
