			...
			<div style="border:5px solid #000; padding:10px;" id='dyn_<?php echo $j; ?>'>
				...
				<table class='table1'>
					...
					<tr>
						...
						<td style="padding: 8px !important;" colspan='5'><?php echo $data['FIRST_NM'] . " " . $data['MIDDLE_NM']; ?></td>
					</tr>
					...
					<tr>
						<th>Date of Birth :</th>
						<td style="padding: 8px !important;" colspan='2'><?php echo date('d-M-y', strtotime($data['BIRTH_DT'])); ?></td>
						<th>Attendance :</th>
						<td style="padding: 8px !important;" colspan='2'><?php	
			if($data['DISP_SEC'] == 'F'){				
			echo ": " .$data['t2_present_days'].'/'.'186'; 			
			}else{
			echo ": " .$data['t2_present_days'].'/'.'185'; 						
			} ?>
						</td>	
					</tr>
				</table>
				...
				<div class='row'>
					<div class='col-sm-12'>
						<table class='table' style="font-size: 12px;">
							...
							<tr>
								<td><br /><br /><b>Date of Result declaration: </b></td>
							</tr>
						</table>
					</div>
				</div>
