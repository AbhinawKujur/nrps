			...
			<div style="border:5px solid #000; padding:10px;" id='dyn_<?php echo $j; ?>'>
				...
				<table style='font-size: 12px !important;padding: 3px !important;width:100%'>
					...
					<tr>
						...
						<td style="padding: 5px !important;" colspan='5'><?php echo $data['FIRST_NM'] . " " . $data['MIDDLE_NM']; ?></td>
					</tr>
					...
					<tr>
						<th>Date of Birth :</th>
						<td style="padding: 5px !important;" colspan='2'><?php echo date('d-M-y', strtotime($data['BIRTH_DT'])); ?></td>
						<th>Attendance :</th>
						
						<?php if($cls == 7){ ?>
							<td style="padding: 5px !important;" colspan='2'><?php echo $data['MAY_ATT'].'/'.$tot_working; ?></td>
							<?php } else{ ?>
								<td style="padding: 5px !important;" colspan='2'><?php echo $data['t2_present_days'].'/'.$tot_working; ?></td>
						 <?php } ?>
				...
				<table class='table'>
					...
					<?php foreach ($data['sub'] as $subject) { ?>
						<tr>
							...
							<td class='th'>
								<?php if ($subject['opt_code'] != 1) { ?>
									<center><?php echo $subject['marks']['second_term']; ?></center>
								<?php } ?>
							</td>
                            <td class='th'>
                                <center><?php echo $sum_marks=+$subject['marks']['marks_obtained']; ?></center>
                            </td>
					...
					<tr>
                        ...
                        <td class='th'> <center><?php echo $grnd_tot; ?></center> </td>
						<?php
						$fin_grade = 0;
