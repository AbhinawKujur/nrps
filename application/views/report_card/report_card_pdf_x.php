            ...
            <div style="border:5px solid #000; padding:10px;" id='dyn_<?php echo $j; ?>'>
                ...
                <table class='table1'>
                    ...
                    <tr>
                        ...
                        <th>Attendance :</th>
                        <td style="padding: 8px !important;"><?php echo ": " . $data['tot_present_day'] . '/' .  '181'; ?>
                        </td>
                    </tr>
                </table>
                <br /><br />
                <table class='table1' border='1'>
                    <tr>
                        ...
                        <th class='th'>
                            <center> MARKS OBT.(PB-1) <br /></center>
                        </th>
                        <!-- <th class='th'>
							<center> MAX. MARKS <br /></center>
						</th> -->
                        <!-- <th class='th'>
                            <center> MARKS OBT.(PB-2) <br /></center>
                        </th> -->
                        <!-- <th class='th'>
                ...
                <div class='row'>
                    <div class='col-xs-12'>
                        <table class='table' border='1' style="width:100%;font-size: 12px">
                            ...
                            <tr>
                                <td colspan='2' style='height:80px;' 'border:1px; font-size:20px'><b>Remarks:</b><p style='font-size:12px'><?php echo $data['rmks']; ?> </p>
                ...
                <div class='row'>
                    <div class='col-sm-12'>
                        <table class='table' style="font-size: 12px;">
                            <tr>
                                <td class='sign'><br /><br /><br />
                                    <center>SIGNATURE OF CLASS TEACHER</center><br /><br /><br />
                                </td>
                                <td class='sign'><br /><br /><br />
                                    <center>SIGNATURE OF PARENTS</center><br /><br /><br />
                                </td>
                                <td class='sign'><br /><br /><br />
                                    <center>SIGNATURE OF PRINCIPAL</center><br /><br /><br />
                                </td>
                            </tr>
                            <tr>
