...
<!-- 
      <div class="col-md-3">
        <a href="<?php echo 'Add_bus_route/edit_details'; ?>"><button type='' class='btn btn-danger'>BACK</button></a>
      </div> -->
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if (data == '1') {
            ...
            window.location.href = "<?php echo base_url('student_transport/Bus_transport'); ?>";
          } else if (data == '4') {
