...
table tr th,td{
	...
	@page { margin: 15px 10px 10px 40px; }
</style>
</head>
<body>
<div>
<p style='float:right; font-size:14px;'>Report Generation Date:<?php echo date('d-M-Y'); ?></p><br />
	<center><h1 style='font-size:28px; position:relative;'><?php //echo $School_Name; ?></h1>
...
<table width='100%'>
	<tr>
		...
		<th width='50%' style='font-size:18px!important;'><center>Daily Collection Report as on <?php echo date('d-M-Y',strtotime($date_type)); ?></center></th>
		<th style='font-size:18px!important;'>Collection Counter:- <?php echo $counter; ?></th>
	</tr>
</table>
<br />
