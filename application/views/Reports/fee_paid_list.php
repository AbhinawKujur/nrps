<ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="index.html">Fee Paid List</a> <i class="fa fa-angle-right"></i></li>
</ol>
<style>
	.table>thead>tr>th,
	.table>tbody>tr>th,
...
<div style="padding: 10px; background-color: white;  border-top:3px solid #5785c3;">
					...
					<div class='row'>
						...
						<div class='col-md-6'>
							<select class='form-control' name='sec' id='sec' disabled>
								...
								?>
										<option value='<?php echo $sec_code->SECTION_NAME; ?>'><?php echo $sec_code->SECTION_NAME; ?></option>
								<?php
									}
								}
								?>
	...
	<center><h3 id='loading'></h3></center>
	<div id='loadNew'>
		...
		if ($('#cw').is(":checked") || $('#ac').is(":checked")) {
			if ($('#cw').is(":checked")) {
				...
				if (viewupto != '') {
					...
					if (classs != '') {
						...
						if (sec != '') {
							...
							$.ajax({
								url: "<?php echo base_url('Fee_Paid_list/fee_paid_classwise') ?>",
								type: "POST",
								data: {
									viewupto: viewupto,
									classs: classs,
				...
				if (viewupto != '') {
					...
					$.ajax({
						url: "<?php echo base_url('Fee_Paid_list/fee_paid_allclasswise') ?>",
						type: "POST",
						data: {
							viewupto: viewupto,
							classs: classs,
