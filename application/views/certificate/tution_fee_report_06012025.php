...
<head>
	<title>Tutioin Fee Certificate</title>
	<meta charset="utf-8">
		...
		<div id="border">
			<div class="row">
				...
				<div class="col-md-7 col-lg-7 col-sm-7">
					<center>
						<h5><?php echo $school_setting[0]->School_Name; ?></h5>
					</center>
					<center>
						<h6><?php echo $school_setting[0]->School_Address; ?></h6>
					</center>
					<center>
						<h6>Affillated to CBSE,New Delhi (Aff No. :<?php echo $school_setting[0]->School_AfftNo; ?>, School Code: <?php echo $school_setting[0]->School_Code; ?>)</h6>
					</center>
					<center>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-lg-6">
					<div id="content">
						<center><b>TUITION FEE CERTIFICATE</b></center>
					</div>
				</div>
			...
			<table class="table">
				<tr>
					<td class="f-s">
						<center><i>This is to certify that <b><?php echo $F_NAME; ?></b> & <b><?php echo $M_Name; ?></b> have paid Tuition Fee for the study of their ward in our
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<center>
					...
					<a class="btn btn-danger" id="print_cancel" href="<?php echo base_url('Tution_fee_certificate/show_tution'); ?>">BACK</a>
				</center>
			</div>
		</div><br /><br />
	</div>
