...
<head>
	<title>Re-print Bonafide Certificate</title>
	<meta charset="utf-8">
		...
		<div id="border">
			<div class="row">
				<div class="col-md-3 col-sm-3 col-lg-3">
					<img src="<?php echo base_url($school_setting[0]->SCHOOL_LOGO); ?>" id='image' style="height:100px !important;width:100px !important;">
				</div>
