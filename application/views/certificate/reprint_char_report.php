...
<head>
	<title>Re-print Character Certificate</title>
	<meta charset="utf-8">
		...
		<div id="border">
			<div class="row">
				...
				<div class="col-md-7 col-lg-7 col-sm-7">
					...
					<center>
						<h5><?php echo $school_setting[0]->School_Address; ?></h5>
					</center>
					<center>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-lg-12" style="visibility:hidden">
