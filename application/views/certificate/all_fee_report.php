...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			<?php
			$adm_str = str_replace('/', '_', $ADM_NO);
			?>
			<div class="col-lg-12 col-md-12 col-sm-12">
				<center>
					<!-- <button class="btn btn-primary" id="printing_button" onclick="printl()"><i class="fa fa-print"></i>&nbsp;PRINT</button>&nbsp; -->
					<span>
						<a href="<?php echo base_url('Fee_paid_all_certificate/fee_details_pdf/' . $adm_str); ?>" target="_blank" class="btn btn-primary" id="generate_pdf" style='display:non'><i class="fa fa-file-pdf-o"></i>&nbsp;GENERATE & DOWNLOAD PDF</a>&nbsp;
					</span>
					<a class="btn btn-danger" id="print_cancel" href="<?php echo base_url('Fee_paid_all_certificate/show_tution'); ?>">BACK</a>
				</center>
			</div>
		</div><br /><br />
	</div>
