		...
		<div id="border">
			<div class="row">
				...
				<div class="col-md-7 col-lg-7 col-sm-7">
					<center>
						<h5><b><?php echo $school_setting[0]->School_Name; ?></b></h5>
					</center>
					<center>
						<h6><?php echo $school_setting[0]->School_Address; ?></h6>
					</center>
					<center>
						<h6>Affillated to <?php echo $school_setting[0]->board; ?>, New Delhi (Aff No. :<?php echo $school_setting[0]->School_AfftNo; ?>, School Code: <?php echo $school_setting[0]->School_Code; ?>)</h6>
					</center>
					<center>
						<h6>Session (<?php echo $school_setting[0]->School_Session; ?>)</h6>
					</center>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-lg-6">
					<div id="content">
						<center><b>BONAFIDE CERTIFICATE</b></center>
					</div>
				</div>
			...
			<table class="table">
				...
				<tr>
					<td class="f-s">
						<center><b><i>bonafide student of this school for academic session <?php echo $school_setting[0]->School_Session; ?> from :</i> &nbsp; <u><?php echo $adm_date1; ?></u></b>&nbsp;<b> To </b>&nbsp; <u><b><?php echo $End_DATE1; ?></b></u></center>
					</td>
				</tr>

				<tr>
					<td class="f-s">
						<center><b><i>As per our admission/withdrawal register his/her date of birth is:</i> &nbsp; <u><?php echo $birth_dt1; ?></u></b></center>
					</td>
				</tr>
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<center>
					...
					<span>
						<a href="<?php echo base_url('Bonafide_certificate/download_bon_details/' . $adm_str); ?>" target="_blank" class="btn btn-primary" id="generate_pdf" style='display:non'><i class="fa fa-file-pdf-o"></i>&nbsp;GENERATE & DOWNLOAD PDF</a>&nbsp;
					</span>
					<a class="btn btn-danger" id="print_cancel" href="<?php echo base_url('Bonafide_certificate/show_bonafide'); ?>">BACK</a>
				</center>
			</div>
		</div><br /><br />
	</div>
