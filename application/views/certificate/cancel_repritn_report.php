	 ...
	 <div id="border">
		<div class="row">
			...
			<div class="col-md-7 col-lg-7 col-sm-7">
				...
				<center><h6>Session (<?php echo $tc_details[0]->session_year; ?>)</h6></center>
			</div>
		...
		<div class="row">
			...
			<table class="table tbl">
				...
				<tr class="tr">
					...
					<td class="td head_name">: <?php echo $tc_details[0]->datacombo011; ?> (<?php echo $tc_details[0]->txtClsW; ?>)</td>
				</tr>
				<!--<tr class="tr">
					<td class="td head">(In Words)</td>
