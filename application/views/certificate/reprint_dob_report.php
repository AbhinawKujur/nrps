...
<head>
	<title>Re-Print DOB Certificate</title>
	<meta charset="utf-8">
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<center>
					...
					<span>
						<a href="<?php echo base_url('Date_of_birth_certificate/bob_details_pdf/' . $adm_str); ?>" target="_blank" class="btn btn-primary" id="generate_pdf" style='display:non'><i class="fa fa-file-pdf-o"></i>&nbsp;GENERATE & DOWNLOAD PDF</a>&nbsp;
					</span>
					<a class="btn btn-danger" id="print_cancel" href="<?php echo base_url('Date_of_birth_certificate/show_dob'); ?>">BACK</a>
				</center>
			</div>
		</div><br /><br />
	</div>
