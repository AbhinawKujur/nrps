...
<form method="POST" action="<?php echo base_url('Certificate/save_char_details'); ?>">
	...
	<div class='row'>
		<div class="col-md-6 col-sm-6 col-lg-6 form-group">
			...
			<input type="text"  name="issue_date" value="<?php echo date('d-M-Y'); ?>" class="form-control">
		</div>
		<div class="col-md-6 col-sm-6 col-lg-6 form-group">
			<label>Class</label>
			<input type="text"  value="<?php echo $student[0]->DISP_CLASS; ?>" name="class" class="form-control">
		</div>
	</div>
	<div class="row">
