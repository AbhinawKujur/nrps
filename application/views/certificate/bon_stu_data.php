...
if ($student) {
	...
	$birth_dt2 = date("d-M-Y", strtotime($birth_dt));
}
?>
<form method="POST" action="<?php echo base_url('Bonafide_certificate/save_bon_details'); ?>">
	...
	<div class='row'>
		<div class="col-md-6 col-sm-6 col-lg-6 form-group">
			<label>D.O.B.</label>
			<input type="text" value="<?php echo $birth_dt2; ?>" readonly class="form-control">
			<input type="hidden" value="<?php echo $birth_dt; ?>" name="birth_dt">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-lg-12 form-group">
			<center>
				<button formtarget="_blank" class="btn btn-success">Save & Print</button>
			</center>
		</div>
	</div>
</form>