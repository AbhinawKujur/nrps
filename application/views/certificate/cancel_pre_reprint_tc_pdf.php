...
<body>
	...
	<table style='width:100%' cellspacing='0' class='table'>
		<tr>
			<td colspan='6' style="font-family:calibri;font-size:12px;font-weight:bold;text-align:center;">Visit us at : www.davnrps.com</td>
		</tr>
		<tr>
			<?php if ($tc_details[0]->PEN <> '') { ?>
			<td class='caption' style="font-family:calibri;font-size:12px;font-weight:bold">TC. No.</td>
			<td colspan='3' class='border_bottom'>: <?php echo $tc_details[0]->TCNO; ?></td>
			<td class='caption' style="font-family:calibri;font-size:12px;font-weight:bold">PEN</td>
			<td colspan='1' class='border_bottom'>: <?php echo $tc_details[0]->PEN; ?></td>
			<?php } else { ?>
			<td class='caption' style="font-family:calibri;font-size:12px;font-weight:bold">TC. No.</td>
			<td colspan='5' class='border_bottom'>: <?php echo $tc_details[0]->TCNO; ?></td>
			<?php } ?>
		</tr>
		<tr>
			<td class='caption' style="font-family:calibri;font-size:12px;font-weight:bold">Adm No.</td>
			<td class='border_bottom'>: <?php echo $tc_details[0]->adm_no; ?></td>
			<td class='caption' style="font-family:calibri;font-size:12px;font-weight:bold">Registration No.</td>
			<td class='border_bottom'>: <?php echo $tc_details[0]->RegistrationNo; ?></td>
			<td class='caption' style="font-family:calibri;font-size:12px;font-weight:bold">Board's Roll No.</td>
			<td class='border_bottom'>: <?php echo $tc_details[0]->BoardRollNo; ?></td>
		</tr>
		<tr>
