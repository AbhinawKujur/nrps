	...
	<div class="menu">
		<ul id="menu">
			...
			<?php if (in_array('viewStudentMaster', permission_data) || in_array('viewScholarship', permission_data) || in_array('viewHouseMaster', permission_data) || in_array('viewCategoryMaster', permission_data) || in_array('viewWardType', permission_data) || in_array('viewReligion', permission_data) || in_array('viewStudentRecordKeeping', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span> Student Information</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<?php } ?>
						<?php if (in_array('viewStudentMaster', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Student_details/generate_rollno'); ?>">Generate Roll No.</a></li>
						<?php } ?>
					</ul>
				</li>
			<?php endif; ?>
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-pencil-square" aria-hidden="true"></i><span> Examination</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<?php if (in_array('viewClassSubAllocation', permission_data)) { ?>
							<li><a class='<?php //if($first_part == 'clswise_subj_allco'){ echo "active"; } 
											?>' href="<?php echo base_url('Teacher_master/clswise_subj_allco'); ?>">Class-Wise Subject Allocation</span>
									<div class="clearfix"></div>
								</a></li>
						<?php } ?>

						<?php if (in_array('viewStuSubAllocation', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a class='<?php //if($first_part == 'stuwise_subj_allco'){ echo "active"; } 
																			?>' href="<?php echo base_url('Teacher_master/stuwise_subj_allco'); ?>">Student-Wise Subject Allocation</a></li>
						<?php } ?>
						<?php if (in_array('viewMaxMarks', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a class='<?php //if($first_part == 'max_marks_allco'){ echo "active"; } 
																			?>' href="<?php echo base_url('Teacher_master/max_marks_allco'); ?>">Maximum Marks Allocation</a></li>
						<?php } ?>
						<?php if (in_array('viewMaxMarks', permission_data)) { ?>
							<!--<li id="menu-academico-avaliacoes" ><a class='<?php //if($first_part == 'max_marks_allco'){ echo "active"; } 
																				?>' href="<?php echo base_url('maxmarks/MaxmarksClasses'); ?>">Maximum Marks Allocation Junior</a></li>-->
						<?php } ?>
						<?php if (in_array('viewMainSubject', permission_data)) { ?>
							<li><a class='<?php //if($first_part == 'index'){ echo "active"; } 
											?>' href="<?php echo base_url('Marks_entry/index'); ?>">Marks Entry Main Subject</span>
									<div class="clearfix"></div>
								</a></li>
						<?php } ?>
						<?php if (in_array('viewMainSubject', permission_data)) { ?>
							<!--<li><a class='<?php //if($first_part == 'index'){ echo "active"; } 
												?>' href="<?php echo base_url('marksentry/MarksClasses'); ?>">Main Subject Junior</span><div class="clearfix"></div></a></li>-->
						<?php } ?>
			...
			<?php if (in_array('viewHomework', permission_data) || in_array('viewUploadedHomeworkDetails', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-clipboard"></i><span> Class Assessment</span> <span class="fa fa-angle-right" style="float: right"></span>
						<div class="clearfix"></div>
					</a>
					<ul id="menu-academico-sub">
			...
			<!--<?php //if(in_array('working', permission_data)): 
				?>
								<li id="menu-academico" ><a href="#"><i class="fa fa-truck" aria-hidden="true"></i><span> Transport Management </span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
								   <ul id="menu-academico-sub" >
									 <li id="menu-academico-avaliacoes" ><a href="<?php //echo base_url('Bus_master_add/bus_details') 
																					?>">Vehicle Master</a></li>
									 <li id="menu-academico-avaliacoes" ><a href="<?php //echo base_url('Bus_incharge_entry/bus_incharge') 
																					?>">Vehicle Incharge</a></li>
									 <li id="menu-academico-avaliacoes" ><a href="<?php //echo base_url('Fees_master/Bus_Stoppage_Master') 
																					?>">Bus Stoppage Master</a></li>
									 <li id="menu-academico-avaliacoes" ><a href="<?php //echo base_url('Bus_trip_master/index') 
																					?>">Add Bus Trip</a></li>
									 <li id="menu-academico-avaliacoes" ><a href="<?php //echo base_url('Driver_master/index') 
																					?>">Driver Master</a></li>
								  </ul>
								</li> 
							<?php //endif; 
			...
			<?php if (in_array('viewVehicleMaster', permission_data) || in_array('viewVehicleIncharge', permission_data) || in_array('viewBusStoppageMaster', permission_data) || in_array('viewAddBusTrip', permission_data) || in_array('viewDriverMaster', permission_data) || in_array('viewAddBusRoute', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-truck" aria-hidden="true"></i><span> Transport Management </span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<?php } ?>
						<!--<li id="menu-academico-avaliacoes"><a href="<?php //echo base_url('Studentrouteallocation/index') 
																		?>">Student Route Allocation</a></li>-->
					</ul>
				</li>
			<?php endif; ?>
			...
			<?php if (in_array('viewHomework', permission_data) || in_array('viewUploadedHomeworkDetails', permission_data)) : ?>
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-envelope-open"></i><span> Leave</span> <span class="fa fa-angle-right" style="float: right"></span>
						<div class="clearfix"></div>
					</a>
					<ul id="menu-academico-sub">
						<li id="menu-academico-avaliacoes"><a href="<?php //echo base_url('stu_leave/StuLeave') 
																	?>">Student Leave</a></li>
					</ul>
				</li>
			<?php endif; ?>
			...
			<?php if (in_array('viewFeeReports', permission_data) || in_array('viewFeeDefaulterList', permission_data) || in_array('viewFeeHeadWiseDefaulter', permission_data) || in_array('viewClassReport', permission_data)) : ?>
				<li id="menu-academico"><a href="#" title="Reports"><i class="fa fa-file" aria-hidden="true"></i><span>Audit Reports</span> <span class="fa fa-angle-right" style="float: right"></span>
						<div class="clearfix"></div>
					</a>
					<ul id="menu-academico-sub">
						<?php if (in_array('viewFeeDefaulterList', permission_data)) { ?>
			...
			<?php
			if (in_array('viewEmployeeLeave', permission_data) || in_array('viewStudentDetails', permission_data)  || in_array('viewStudentMaster', permission_data)) :
			?>
...
<script>
	...
	$(".sidebar-icon").click(function() {
		if (isMobile()) {
			// In mobile view, toggle between expanded and collapsed states
			if (toggle) {
			...
			// In desktop view, normal collapse/expand behavior
			if (toggle) {
				$(".page-container").addClass("sidebar-collapsed").removeClass("sidebar-collapsed-back");
				// Close all submenus when collapsing
				$("#menu-academico").removeClass("active");
				$("#menu-academico-sub").slideUp(300);
			} else {
				$(".page-container").removeClass("sidebar-collapsed").addClass("sidebar-collapsed-back");
			}
		}
	...
	// Submenu toggle on click for all menu-academico items
	$(document).on("click", "#menu-academico > a", function(e) {
		e.preventDefault(); // Prevent default link behavior
		e.stopPropagation(); // Prevent event bubbling to parent elements

		var $parentLi = $(this).parent(); // Get the parent <li>
		var $submenu = $(this).next("#menu-academico-sub"); // Get the submenu
		var isCollapsed = $(".page-container").hasClass("sidebar-collapsed");

		// If sidebar is collapsed and not in mobile view, expand it first
		...
		if ($parentLi.hasClass("active")) {
			...
			$("#menu-academico").not($parentLi).removeClass("active");
			$("#menu-academico").not($parentLi).find("#menu-academico-sub").slideUp(300);

			// Open the clicked submenu
			$parentLi.addClass("active");
			$submenu.slideDown(300); // Open submenu with slide animation
		}
	});

	// Handle submenu item clicks without closing the parent menu
	$(document).on("click", "#menu-academico-sub a", function(e) {
		e.stopPropagation(); // Prevent event bubbling to parent menu

		// Remove 'selected' class from other submenu items
		$("#menu-academico-sub a").removeClass("selected");

		// Add 'selected' class to the clicked submenu item
		$(this).addClass("selected");

		// Allow the default link behavior (e.g., navigating to the URL)
		// The parent menu remains open, so the user can click another submenu item
	});

	// Ensure sidebar is expanded on page load in mobile view
...
<form method="post" action="<?php echo base_url('userauth/check_auth/verify_bank_password'); ?>">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" style="text-align-last: center">Enter Password</h4>
				</div>
				<div class="modal-body">
					<input type="password" name="user_pwd" id="user_pwd" value="" class="form-control">
				</div>
