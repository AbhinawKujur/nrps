...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Security Registar</a> <i class="fa fa-angle-right"></i></li>
</ol>
...
<script>
    ...
    $("#form").on("submit", function(event) {
        ...
        $.ajax({
            url: "<?php echo base_url('Admission_registar/security_registar_details'); ?>",
            type: "POST",
            data: $('#form').serialize(),
            beforeSend: function() {
                $('.loader').show();
