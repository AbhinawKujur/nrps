...
<ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="index.html">Generate Roll No.</a> <i class="fa fa-angle-right"></i></li>
</ol>
...
<script>
	$("#form").on("submit", function(event) {
		...
		$.ajax({
			url: "<?php echo base_url('student_details/generate_rollno_acorderby'); ?>",
			type: "POST",
			data: $('#form').serialize(),
			beforeSend: function() {
				$('.loader').show();
