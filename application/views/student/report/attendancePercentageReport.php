                  ...
                  <form id="printForm" action="<?php echo base_url('student/report/attendancepercentagereport'); ?>" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="class_id" id="class_id" required="">
                        ...
                        <option value="<?php echo $classList[0]['class_no']?>"><?php echo $classList[0]['disp_class'] ?></option>
                      </select>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <option value="">Select</option>
                        <option value="<?php echo $classList[0]['section_no']?>"><?php echo $classList[0]['disp_sec'] ?></option>
                      </select>
                    </div>
                  </div>
                      <div class="col-sm-2">
