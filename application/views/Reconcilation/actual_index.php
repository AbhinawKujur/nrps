<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Fee Reconcilation Actual Collection Headwise</a> <i class="fa fa-angle-right"></i></li>
</ol>
    ...
    <form id='form'>
        <div class="row">
            ...
            <div class="col-md-3 form-group">
                ...
                <select name="coll_mode" id="coll_mode" class='form-control'>
                    <option value="ALL"> ALL</option>
                    <option value="A"> SCHOOL</option>
                    <option value="ON">ONLINE</option>
                    <option value="D"> BANK</option>
                </select>
            </div>
...
<script>
    $("#form").on("submit", function(event) {
        ...
        var coll_mode = $('#coll_mode').val();
        $.ajax({
            url: "<?php echo base_url('Reconcilation/actual_calculate'); ?>",
            type: "POST",
            data: {
                month: month,
                feehead: feehead,
