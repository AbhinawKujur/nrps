<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Fee Reconcilation Advance Headwise</a> <i class="fa fa-angle-right"></i></li>
</ol>
...
<script>
    $("#form").on("submit", function(event) {
        ...
        $.ajax({
            url: "<?php echo base_url('Reconcilation/advance_calculate'); ?>",
            type: "POST",
            data: {
                month: month,
                feehead: feehead,
