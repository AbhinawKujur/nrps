...
<div class='row'>
    <div class='col-md-12 col-xl-12 col-sm-12'>
        <form action="<?php echo base_url('Reconcilation/downloadpdf_act'); ?>" method="post" target='_blank'>
            <input type="hidden" name='feehead' value="<?php echo $feehead; ?>">
            <input type="hidden" name='month' value="<?php echo $month; ?>">
            <input type="hidden" name='coll_mode' value="<?php echo $coll_mode; ?>">
            <center>
            ...
            <table id='example' class="table-bordered table-striped">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="color: red;font-weight:700;"><?php echo $GRAND_TOT_ACT; ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'excelHtml5',
                    title: 'Reconcilation Actual  Report',
