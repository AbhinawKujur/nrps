...
<head>
    <title>Reconcilation Report of Advance</title>
    <style>
        table {
    ...
    <table width='100%'>
        <tr>
            <th width='50%' style='font-size:16px!important;border:none'>
                <center>Reconcilation Report of Advance for the month -
                    <?php
                    if ($month == 1) {
                        echo 'JAN - ' . $new_sess;
                    } elseif ($month == 2) {
    ...
    <table style="border: 1px solid #000;width:100% !important;">
        <thead>
            <tr>
                ...
                <th width='5%'><b>MONTHS PAID</b></th>
                <th width='5%'><b>ADV. MONTHS PAID</b></th>
                <th width='5%'><b>RATE</b></th>
                <th width='10%'><b>ADVANCE AMT.</b></th>
        </thead>
        <tbody>
            <?php
            $i = 1;
