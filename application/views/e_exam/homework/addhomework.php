...
<div class='mainb' style="padding: 15px; background-color: white; border-top: 3px solid #5785c3;">
  <div class="row">
    <div class='col-sm-12'>
		...
		<table class='table'>
			...
			<tr>
				<th>Subject</th>
				<td>
					<select class='form-control' name='subject' required id='subj' onchange='insertValidation()'>
						<option value=''>Select</option>
					</select>
				</td>
	...
	<tbody>
		<?php
			foreach($e_exam_questions_hw as $key => $val){
