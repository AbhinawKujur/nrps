		...
		<table class='table'>
			...
			<tr>
				<td id='load_topic' colspan='5'>
					...
					<textarea type='text' name='question[]' id='topic' class='form-control topic' required rows='4'><?php echo $val['question']; ?></textarea>
					<div class='row'>
						<div class='col-sm-4'>
