...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Notice</a> <i class="fa fa-angle-right"></i> Sent Report Details </li>
</ol>
  ...
  <div class="row">
     ...
     <div class='col-sm-8'>
        ...
        <table class='table dataTable'>
			<thead>
				<tr>
					<th style='background:#337ab7; color:#fff !important'>Sent Type</th>
...
<script type="text/javascript">
   $(".alert").fadeOut(5000);
   $('.dt').datepicker({ format: 'dd-M-yyyy',autoclose: true,endDate: '+1d', });
   $("#multiselect").select2();
