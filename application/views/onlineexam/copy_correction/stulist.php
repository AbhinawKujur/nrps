...
<div class="panel panel-primary">
      <div class="panel-heading">Exam Copy Correction</div>
...
<script>
	function classess(class_code){
		...
		$.ajax({
			url: "<?php echo base_url('onlineexam/copy_correction/CopyCorrection/Class_sec'); ?>",
			type: "POST",
	...
	function section_sec(sec_no){
		...
		$.ajax({
			url: "<?php echo base_url('onlineexam/copy_correction/CopyCorrection/subject_nam'); ?>",
			type: "POST",
	...
	function subject_ids(subject_ids){
		...
		if(subject_ids!=""){
		$.ajax({
			url: "<?php echo base_url('onlineexam/copy_correction/CopyCorrection/examDate'); ?>",
			type: "POST",
	...
	function btn_submit(){
		...
		$.ajax({
			url: "<?php echo base_url('onlineexam/copy_correction/CopyCorrection/stulist'); ?>",
			type: "POST",
	...
	function marksd(value,qid){	
		...
		if(maxmarks>=marks){
		$.post("<?php echo base_url('onlineexam/copy_correction/CopyCorrection/marks_entry'); ?>",{qid:qid,marks:marks,remarks:remarks},function(data){
