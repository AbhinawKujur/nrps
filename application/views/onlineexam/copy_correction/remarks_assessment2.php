 ...
 ?>
   ...
   <div class="table-responsive">
		 	<table class='table'>			
				...
				<input type="text" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57 || event.charCode == 46 || event.charCode == 97 || event.charCode == 98 || event.charCode == 65 || event.charCode == 66 || event.charCode == 13" onchange="marksd(this.value,'<?=$vals->id;?>')" maxlength='3' name="marks" id="marks_<?=$vals->id;?>" disabled style="background-color:#f1b0b0; text-align:center" value="<?=$vals->stu_marks; ?>" class="form-control test">
					<input type="hidden" name="maxmarks" value="<?=$vals->marks; ?>" id="maxmarks_<?=$vals->id;?>" >
					<?php //} ?>
					</td>
				<td style="border: 1px solid ;" >
				<?php //if(!empty($vals->ans) || $vals->img_status>0){?>
					<select name="remarks" class='form-control' id='remarks_<?=$vals->id;?>' readonly disabled >
					...
					<br>
					<textarea name='comment' id='comment_<?=$vals->id;?>' disabled  class='form-control'><?=$vals->comment; ?></textarea>
						<?php //} ?>
				</td>
				</tr>
				<?php } ?>
