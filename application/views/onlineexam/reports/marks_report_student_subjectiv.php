...
<?php $t=""; ?>
<ol class="breadcrumb">
  <li class="breadcrumb-item"><a href="#">Subjective Marksheet </a> <i class="fa fa-angle-right"></i></li>
</ol>
<!--four-grids here-->
...
<script>
	function classess(class_code){
		...
		$.ajax({
			url: "<?php echo base_url('onlineexam/reports/MarksReportstudentsubjectiv/Class_sec'); ?>",
			type: "POST",
	...
	function section_sec(sec_no){
		...
		$.ajax({
			url: "<?php echo base_url('onlineexam/reports/MarksReportstudentsubjectiv/subject_nam'); ?>",
			type: "POST",
	...
	function subject_ids(subject_ids){
		...
		$.ajax({
			url: "<?php echo base_url('onlineexam/reports/MarksReportstudentsubjectiv/examDate'); ?>",
			type: "POST",
	...
	function btn_submit(){
		...
		$.ajax({
			url: "<?php echo base_url('onlineexam/reports/MarksReportstudentsubjectiv/generateMarksReport'); ?>",
			type: "POST",
