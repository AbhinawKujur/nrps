...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Monthly Join/Leave</a> <i class="fa fa-angle-right"></i></li>
</ol>
...
<div style="padding: 10px; background-color: white;  border-top:3px solid #5785c3;">
    ...
    <form id="form" method="post">
        <div class="row">
                    ...
                    <label>New Join</label>
                    <input type="radio" name="choice" id="new" Value="1">
                    <label>Pass Out</label>
                    <input type="radio" name="choice" id="old" Value="2">
                </div>
            </div>
...
<script>
    $("#form").on("submit", function(event) {
        ...
        $.ajax({
            url: "<?php echo base_url('Other_report/monthlty_join_report'); ?>",
            type: "POST",
            data: $('#form').serialize(),
            beforeSend: function() {
                $('.loader').show();
