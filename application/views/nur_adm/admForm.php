			...
			<fieldset class="scheduler-border">
				<legend class="scheduler-border">PARENTS' DETAILS</legend>
					...
					<div class='col-sm-6'>
						...
						<input type='radio' name='grnd_prnt' value='YES' onclick="grnd_prntt('YES')"> YES <input type='radio' name='grnd_prnt' value='NO' onclick="grnd_prntt('NO')" checked> NO 
					</div>
						...
						<fieldset class="scheduler-border">
							...
							<div class='col-sm-6'>
								<div class="form-group">
									...
									<input type="email" class="form-control" name='email' id='email' onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode >= 64 && event.charCode <= 90 || event.charCode >= 97 && event.charCode <= 122 || event.charCode == 95|| event.charCode == 46' onchange='checkExist()' style='text-transform: lowercase'>
								</div>
							</div>
							<div class='col-sm-12'>
								<div class="form-group">
