...
<head>
	...
	<style>
		...
		body{
			background-image: url(<?php echo base_url('assets_nur/image/ww.jpg'); ?>);
    ...
    <div class="wrapper">
       ...
       <div class="login-div">
          ...
          <div class="full">
			...
			<!--<center><span style='font-size:16px !important; color:red'>New Applicant <a href='<?php //echo base_url('adm_nur/Adm_nur'); ?>'>Click Here<a/></span></center>-->
          </div>
		  </form>
       </div>
    </div>
