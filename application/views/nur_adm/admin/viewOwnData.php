			...
			<fieldset class="scheduler-border">
				<legend class="scheduler-border">PARENT'S DETAILS</legend>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='f_jbo_transferable' disabled>
											...
											<option value='NO' <?php if($stuData[0]['f_jbo_transferable'] == 'YES'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
					...
					<div class='col-sm-12'>
							...
							<input type='radio' <?php if($stuData[0]['grand_parent'] != 4){ echo "checked"; } ?> name='grnd_prnt' value='YES' onclick="grnd_prntt('YES')" disabled> YES 
							
							<input type='radio' <?php if($stuData[0]['grand_parent'] == 4){ echo "checked"; } ?> name='grnd_prnt' value='NO' onclick="grnd_prntt('NO')" disabled> NO 
						</div>
						<div class='col-sm-6'>
							<div class="form-group">
