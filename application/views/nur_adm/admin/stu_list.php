...
<script>
	...
	function startDate(value){
		...
		$.ajax({
			url: "<?php echo base_url('adm_nur/reports/RegisteredStu/ReportStuData'); ?>",
			type: "POST",
			data: {value:value},
	...
	function endDate(){
		...
		$.ajax({
			url: "<?php echo base_url('adm_nur/reports/RegisteredStu/ReportStuDateRange'); ?>",
			type: "POST",
	...
	function verifiedReportDateRange(){
		...
		$.ajax({
			url: "<?php echo base_url('adm_nur/reports/RegisteredStu/ReportStuDateRangeStatus'); ?>",
			type: "POST",
