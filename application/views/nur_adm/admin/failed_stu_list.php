...
<script>
	...
	function startDate(value){
		...
		$.ajax({
			url: "<?php echo base_url('adm_nur/reports/FailedTransReport'); ?>",
			type: "POST",
			data: {value:value},
	...
	function endDate(){
		...
		$.ajax({
			url: "<?php echo base_url('adm_nur/reports/FailedTransReport/ReportStuDateRange'); ?>",
			type: "POST",
	...
	function verifiedReportDateRange(){
		...
		$.ajax({
			url: "<?php echo base_url('adm_nur/reports/FailedTransReport/ReportStuDateRangeStatus'); ?>",
			type: "POST",
