		...
		<center>
				...
				<tr>
					<td>
						<center>
							...
							<b><center><span style='font-size:14px !important;'>NURSERY REGISTRATION FORM (for session 2020-2021)</span></center></b>
						</center>
					</td>
				</tr>
			</table>
			...
			<span class='animated rubberBand' style='font-size:16px;'><b>Acknowledgement of Payment</b></span>
				<table class='table'>
					...
					<tr>
						<td colspan='2'><span style='color:#fff; background:red; border-radius:2px; padding:3px; font-size:12px;'>Payment of Rs. 1500.00 is due</span></td>
					</tr>
				</table>
			<a href='<?php echo base_url('adm_nur/payment/Payment'); ?>' class='btn btn-success form-control'>Pay Now</a>
		</center>
