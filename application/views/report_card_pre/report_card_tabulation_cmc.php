...
<div class='table-responsive'>
	...
	<!--
    <a target='_blank' href="<?php echo base_url('report_card/Report_card/tabulation_cmc_pdf/' . $trm . '/' . $term . '/' . $classs . '/' . $sec . '/' . $date . '/' . $round); ?>" class='btn btn-info'> <i class="fa fa-file-pdf-o"></i> PDF </a>
