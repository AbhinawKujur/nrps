			...
			<div style="border:5px solid #000; padding:10px;" id='dyn_<?php echo $j; ?>'>
				...
				<table style='border:none !important;' class='table'>
					...
					<tr>
						...
						<td>
							<b>
								<center><span style='font-size:16px !important;'><b>REPORT CARD-PRE BOARD</b></span></center>
							</b>
						</td>
				...
				<table class='table1'>
					...
					<tr>
						...
						<th>Attendance :</th>
						<td style="padding: 8px !important;"><?php
																if ($data['DISP_SEC'] == 'F' || $data['DISP_SEC'] == 'E') {
																	echo ": " . $data['tot_present_day'] . '/' . '182';
																} else {
																	echo ": " . $data['tot_present_day'] . '/' . '181';
																} ?>
						</td>
					</tr>
				</table>
						...
						<tr>
							...
							<th class='th'>
								<center>
									...
									?>80
								<?php } elseif ($subject['subject_code'] == '402') {
								?> 50
				...
				<div class='row'>
					<div class='col-xs-12'>
						<table class='table' border='1' style="width:100%;font-size: 14px !important;">

							<tr>
								<td colspan='2' style='height:100px;' 'border:1px;'><b>Remarks:</b><br /><?php echo ucfirst($data['rmks']); ?></td>
							</tr>
						</table>
					</div>
				...
				<div class='row'>
					<div class='col-sm-12'>
						<table class='table1' style="font-size: 12px;height:100px;width:100%;">
							<tr>
								<td class='sign' style='width:33.3%;'><br /><br /><br /><br />
							...
							<tr>
								<td><br /><br /><br /><br /><br /><b>Date of Result declaration: 08-FEB-2025</b></td>
							</tr>
						</table>
					</div>
				</div>
