...
<script>
    ...
    function classes(val) {
        $.post("<?php echo base_url('report_card/Report_card_pre/classess_report_card'); ?>", {
            val: val
        }, function(data) {
    ...
    function generate() {
        ...
        if (radioValue == 1) {
            $.ajax({
                url: "<?php echo base_url('report_card/Report_card_pre/make_report_card'); ?>",
                type: "POST",
            ...
            $.ajax({
                url: "<?php echo base_url('report_card/Report_card_pre/make_report_card_tabulation'); ?>",
                type: "POST",
                data: $("#stu_form").serialize(),
                success: function(data) {
                    $("#btnload").hide();
