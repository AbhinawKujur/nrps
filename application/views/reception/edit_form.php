...
<div style="background-color: white;padding: 20px;border-top: 3px solid #5785c3;">
	...
	<form name="reg_form" action="<?php echo base_url('reception/Visitreg_form/update_visit'); ?>" method="post" enctype="multipart/form-data">
	<input type="hidden" name="my_id" value="<?php echo $data->id; ?>"/>
		<div class="row">
			<div class="col-sm-4">
				<div class="form-group">
					<label><b>Visit Date</b></label><span class="span"></span>
					<input type="date" name="vis_date" id='vis_date' class="form-control" value="<?php echo $data->visit_date; ?>">
				</div>
			</div>
			<div class="col-sm-4">
				<div class="form-group">
					...
					<select class='form-control' id='mode_id' name='mode_id' required>
						...
						?>
							<option value='<?php echo $val->id; ?>' <?php if ($val->id == $data->entry_mode) { ?> selected <?php } ?>><?php echo $val->mode_type; ?></option>
						<?php
						}
						?>
					</select>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<select class='form-control' id='dept' name='dept' required>
						...
						?>
							<option value='<?php echo $val->id;  ?>' <?php if ($val->id == $data->dept_id) { ?>selected <?php } ?>><?php echo $val->dept; ?></option>
						<?php
						}
						?>
					</select>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<select class='form-control' id='vis_purpose' name='vis_purpose' required>
						...
						?>
							<option value='<?php echo $val->id; ?>' <?php if ($val->id == $data->vis_pur_id) { ?> selected <?php } ?>><?php echo $val->vis_purpose; ?></option>
						<?php
						}
						?>
					</select>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<select class='form-control' id='vis_type' name='vis_type' required onchange="visit_val(this.value)">
						...
						?>
							<option value='<?php echo $val->id; ?>' <?php if ($val->id == $data->vis_type_id) { ?> selected <?php } ?>><?php echo $val->vis_type; ?></option>
						<?php
						}
						?>
					</select>
			...
			<div class="col-md-4" id="emp" style="display:none;">
				<div class="form-group">
					...
					<select class='form-control' id='emp_id' name='emp_id' onchange="emp_fil(this.value)" style='width:100%'>
						...
						?>
							<option value='<?php echo $data->emp_id; ?>' <?php if ($val->id == $data->emp_id) { ?> selected <?php } ?>> <?php echo
																																		$val->EMPID . ' (' . $val->EMP_FNAME . '  ' . $val->EMP_MNAME . ')'; ?></option>
						<?php
						}
						?>
					</select>
			...
			<div class="col-md-4" id="suppl" style="display:none;">
				<div class="form-group">
					...
					<select class='form-control' id='sup_id' name='sup_id' onchange="suppl_fil(this.value)" style='width:100%'>
						...
						?>
							<option value='<?php echo $val->id; ?>' <?php if ($val->id == $data->vis_type_id) { ?>selected <?php } ?>><?php echo $val->Supplier_Name; ?></option>
						<?php
						}
						?>
					</select>
		...
		<div class="row" id="stt" style="display:none;">
			...
			<div class="col-md-3" id="suu" style="display:none;">
				<div class="form-group">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<input type="text" readonly name="stu_class" id='stu_class' class="form-control" required onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 58' maxlength="5">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="text" name="name" id='name' class="form-control" onkeypress='return event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 97 && event.charCode <= 122 || event.charCode == 32 || event.charCode == 46 || event.charCode == 47' maxlength="30" value="<?php echo $data->name; ?>">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					<label><b>Mobile</b></label><span class="span">*</span>
					<input type="text" id='mobile' name="mobile" maxlength="10" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php echo $data->mobile; ?>">
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="text" name="in_time" id='in_time' class="form-control" required onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 58' maxlength="5" value="<?php echo $data->in_time; ?>">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<textarea rows="5" cols="50" id="remarks" name="remarks" maxlength="150" value="<?php echo $data->remarks; ?>"></textarea>
				</div>
			</div>
		</div>
		<div class="row">
