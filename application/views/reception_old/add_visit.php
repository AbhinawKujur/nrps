...
<div class="row">
		<div class='col-sm-6'>
	     ...
	     <div class="col-md-3">
          <center><a href="<?php echo base_url('reception/Visitreg_form/download_form'); ?>" class="btn btn-success" target="_blank">Download Form</a></center>
        </div>
        <div class='col-sm-9'>		
	...
	<form name="reg_form" id="reg_form" action="<?php echo base_url('reception/Visitreg_form/save_visit'); ?>" method="post">
	
	<div class="row">
	<div class="col-sm-4">
		  <div class="form-group">
			<label><b>Visit Date</b></label><span class="span"></span>
			<input type="text" readonly name="vis_date" id='vis_date' class="form-control" value="<?php echo $today_date;?>">
		  </div>
		</div>
		<div class="col-sm-4">
		  <div class="form-group">
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="text" id='mobile' name="mobile" maxlength="12" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="text" readonly name="in_time" id='in_time' class="form-control" required onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 58' maxlength="5" value="<?php echo $cur_time;?>">
