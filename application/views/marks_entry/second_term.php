		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
			  ...
			  <div class="modal-footer">
				<a onclick='alert("Marks Saved Successfully")' class="btn btn-success btn-xs" data-dismiss="modal">Save</a>
...
<script>
  ...
  function exam_type(ExamCode){
	 ...
	 $.post("<?php echo base_url('marks_entry/subject2'); ?>",{ExamCode:ExamCode,Class_No:Class_No,sec:sec,ExamMode:ExamMode},function(data){
		 var fill = $.parseJSON(data);
		 $("#sub").html(fill[0]);
  ...
  function approve(Class_No,sec,sorting,exm_code,subcode,trm){
	  $.ajax({
		  url : "<?php echo base_url('Marks_entry/verifyMarks'); ?>",
		  type: "POST",
		  data: {Class_No:Class_No,sec:sec,sorting:sorting,exm_code:exm_code,subcode:subcode,trm:trm},
