...
class FeeGeneration_new extends MY_Controller
{
    ...
    public function index()
    {
        ...
        if ($month1 == '01') {
            ...
            $stu_monthFee = "JAN_FEE";
        }
        elseif ($month1 == '02') {
            $month1 = 'FEB';
            
            $stu_monthFee = "FEB_FEE";
        }
        elseif ($month1 == '03') {
            $month1 = 'MAR';
            
            $stu_monthFee = "MAR_FEE";
        }
        elseif ($month1 == '04') {
            $month1 = 'APR';
            
            $stu_monthFee = "APR_FEE";
        }
        elseif ($month1 =='05') {
            $month1 = 'MAY';
            
            $stu_monthFee = "MAY_FEE";
        }
        elseif ($month1 == '06') {
            $month1 = 'JUN';
        ...
        elseif ($month1 == '08') {
            ...
            $stu_monthFee = "AUG_FEE";
        }
        elseif ($month1 == '09') {
            $month1 = 'SEP';
            
            $stu_monthFee = "SEP_FEE";
        }
        elseif ($month1 == '10') {
            $month1 = 'OCT';
            
            $stu_monthFee = "OCT_FEE";
        }
        elseif ($month1 == '11') {
            $month1 = 'NOV';
            
            $stu_monthFee = "NOV_FEE";
        }
        elseif ($month1 == '12') {
            $month1 = 'DEC';
            
            $stu_monthFee = "DEC_FEE";
        }
        // echo $month1;
        // echo $stu_monthFee;die;
        if ($month1 == "JUN") {
            $stu_monthFee = "JUNE_FEE";
        } elseif ($month1 == "JUL") {
            $stu_monthFee = "JULY_FEE";
        ...
        $check_month = $this->db->query("SELECT DISTINCT(Month_Nm) from feegeneration WHERE Month_Nm='$month1'")->result();
        $count_chck = count($check_month);
