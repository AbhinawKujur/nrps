...
class StudentBookReturn extends MY_controller{
	...
	public function index(){		
		...
		//$data['issuedbok'] 		= $this->pawan->selectA('books_applied',"*,(select FIRST_NM from student where 						         letterno=books_applied.Admno)stu_nm","Issued='1'");	18/05/2023
		
		$data['issuedbok'] 		= $this->pawan->selectA('books_applied', "*,
		(select concat_ws(' ',FIRST_NM,MIDDLE_NM,TITLE_NM)as stu_name1 from student where studentid=books_applied.Admno)stu_nm1,
		(select concat_ws(' ',FIRST_NM,MIDDLE_NM,TITLE_NM)as stu_name2 from student_1718 where studentid=books_applied.Admno)stu_nm2,
		(select concat_ws(' ',FIRST_NM,MIDDLE_NM,TITLE_NM)as stu_name3 from student_1819 where studentid=books_applied.Admno)stu_nm3,
		(select concat_ws(' ',FIRST_NM,MIDDLE_NM,TITLE_NM)as stu_name4 from student_1920 where studentid=books_applied.Admno)stu_nm4" , "Issued='1'");
	...
	$adm=str_replace("-","/","$adm");
		...
		$data['StuDetail']  = $this->pawan->selectA('student','*',"STUDENTID='$adm'");
