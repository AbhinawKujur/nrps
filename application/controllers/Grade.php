		...
		<form id='formm' method='POST'>
		  <table class='table'>
		    <tr>
			  ...
			  <th style="background:#5785c3; color:#fff!important;">WORK EDU.</th>
			  <th style="background:#5785c3; color:#fff!important;">ART EDU.</th>
			  <th style="background:#5785c3; color:#fff!important;">HEALTH & PHYSICAL EDU.</th>
			  <th style="background:#5785c3; color:#fff!important;">VALUE|VEDIC EDU.</th>
			  <th style="background:#5785c3; color:#fff!important;">DISCIPLINE</th>
		    </tr>
			<?php
			if(isset($data)){
				foreach($data as $co_data){
					...
					<tr>
						...
						<td><input type="text" onkeypress='return event.charCode >= 97 && event.charCode <= 101 || event.charCode == 45 || event.charCode >= 65 && event.charCode <= 69' maxlength='1' value="A" name='skill5[]' style="width:50px;"></td>
						...
						<td><input type="text" onkeypress='return event.charCode >= 97 && event.charCode <= 99 || event.charCode == 45 || event.charCode >= 65 && event.charCode <= 67' maxlength='1' value="A" name='skill5[]' style="width:50px;"></td>
					...
					if(isset($data)){
						foreach($data as $co_data){
							...
							<tr>
								...
								<td><input type="text" onkeypress='return event.charCode >= 97 && event.charCode <= 101 || event.charCode == 45 || event.charCode >= 65 && event.charCode <= 69' maxlength='1' value="<?php echo $co_data->skill5; ?>" name='skill5[]' style="width:50px;"></td>
								...
								<td><input type="text" onkeypress='return event.charCode >= 97 && event.charCode <= 99 || event.charCode == 45 || event.charCode >= 65 && event.charCode <= 69' maxlength='1' value="<?php echo $co_data->skill5; ?>" name='skill5[]' style="width:50px;"></td>
	...
	function saveGrade(){
		...
		foreach($admno as $key => $val){
				...
				$insDataSkill5 = array(
					...
					'Term'      => $this->input->post('trm'),
					'SkillCode' => 5,
					'Grade'     => strtoupper($this->input->post('skill5')[$key]),
					'user_id'   => login_details['user_id']
				);
				$this->alam->insert('co_scholastic_grade',$insDataSkill5);
		}
	}
