...
class Cmonthly_calculation extends MY_Controller{
	...
	public function get_pay_details()
	{
		...
		$gross_amount = $final_amount[1] + $final_amount[2] + $final_amount[3] + $final_amount[4] + $final_amount[5] + $final_amount[6] + $final_amount[7] + $final_amount[8] + $finalfee9amt + $final_amount[10] + $final_amount[11] + $final_amount[12] + $final_amount[13] + $finalfee14amt + $final_amount[15] + $final_amount[16] + $final_amount[17] + $final_amount[18] + $final_amount[19] + $final_amount[20] + $final_amount[21] + $final_amount[22] + $final_amount[22] + $final_amount[23] + $final_amount[24] + $final_amount[25] + $recover ;
